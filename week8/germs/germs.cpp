...
EK::FT S_to_hrs(EK::FT const & S){return CGAL::sqrt((CGAL::sqrt(S) - 1) / 2);}
...
void test_case(int n){
	...
	for (delaunay_t::Finite_vertices_iterator v = trg.finite_vertices_begin(); v != trg.finite_vertices_end(); ++v){
